...
import { ConnectorRegistry } from "@/components/platform/ConnectorRegistry";
import { 
  CloudLightning, 
  Grid, 
  Globe, 
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-white/40 font-light text-base mt-1">
            Browse and connect custom adapters to link standard services with GHF's layout system.
          </p>
        </div>
      </header>
