        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              ...
              <button className="w-12 h-12 rounded-full flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-colors tooltip-trigger relative group">
              ...
              <button className="w-12 h-12 rounded-full flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-colors relative group">
