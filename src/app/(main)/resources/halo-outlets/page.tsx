...
export default function HaloOutletsLandingPage() {
  ...
  return (
    <div className="min-h-screen px-12 py-10" style={{ backgroundColor: "var(--background)" }}>
      ...
      <div className="flex items-center justify-between mb-10 border-b border-[var(--border)] pb-6">
        <div>
          ...
          <p className="text-xs text-[var(--muted-foreground)] mt-1">
            Select a brand to view prestige accounts, independent outlets, and national group listings
          </p>
        </div>
        <button
      ...
      {/* Brand Grid */}
      <BrandTileGrid basePath="/resources/halo-outlets" />
    </div>
  );
}
