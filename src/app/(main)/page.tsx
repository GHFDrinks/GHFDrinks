...
export default function HomePage() {
  ...
  const categories = [
    { label: "Spirits", brands: spirits, href: "/brands/spirits" },
    { label: "Wines", brands: wines, href: "/brands/wines" },
    { label: "Beer. Cider. Mixer.", brands: beer, href: "/brands/beer" },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Header banner */}
      <div
        className="px-12 py-14 border-b border-gray-100"
      ...
      <div className="px-12 py-10">
        ...
        {loading ? (
          ...
          <div className="space-y-12">
            {categories.map(({ label, brands: catBrands, href }) => (
              <div key={label}>
                  ...
                  <div className="flex gap-6 overflow-x-auto pb-2">
                    {catBrands.map((b) => (
                      ...
                      >
                        ...
                        {b.bcorp && (
                          <p
                            className="text-[9px] text-center mt-0.5 tracking-widest uppercase"
